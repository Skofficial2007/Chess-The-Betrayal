...
namespace ChessTheBetrayal.Tests.EditMode.Core.Engine.Movement
{
    ...
    public class PawnMovementTests
    {
        ...
        public void GetLegalMoves_WhitePawnOnStartingRank_ReturnsTwoForwardMoves()
        {
            ...
            // Act
            ChessEngine.GetLegalMoves(board, BoardSetup.AlgebraicToVector("e2"), _outputBuffer);

            // Assert
            Assert.That(_outputBuffer.Count, Is.EqualTo(2));
            HashSet<Vector2Int> destinations = BoardSetup.GetDestinations(_outputBuffer);
            Assert.That(destinations, Contains.Item(BoardSetup.AlgebraicToVector("e3")));
            Assert.That(destinations, Contains.Item(BoardSetup.AlgebraicToVector("e4")));
        }
        ...
        public void GetLegalMoves_WhitePawnHasMoved_ReturnsOnlyOneForwardMove()
        {
            ...
            // Act
            ChessEngine.GetLegalMoves(board, BoardSetup.AlgebraicToVector("e3"), _outputBuffer);

            // Assert
            Assert.That(_outputBuffer.Count, Is.EqualTo(1));
            Assert.That(_outputBuffer[0].EndPosition, Is.EqualTo(BoardSetup.AlgebraicToVector("e4")));
        }
        ...
        public void GetLegalMoves_WhitePawnWithEnemyOnDiagonals_ReturnsCaptureMovesAndForwardMoves()
        {
            ...
            // Act
            ChessEngine.GetLegalMoves(board, BoardSetup.AlgebraicToVector("e4"), _outputBuffer);

            // Assert
            Assert.That(_outputBuffer.Count, Is.EqualTo(3));
            HashSet<Vector2Int> destinations = BoardSetup.GetDestinations(_outputBuffer);
            Assert.That(destinations, Contains.Item(BoardSetup.AlgebraicToVector("e5"))); // Forward
            Assert.That(destinations, Contains.Item(BoardSetup.AlgebraicToVector("d5"))); // Capture left
            Assert.That(destinations, Contains.Item(BoardSetup.AlgebraicToVector("f5"))); // Capture right
        }
        ...
        public void GetLegalMoves_WhitePawnWithFriendlyPieceOnDiagonal_DoesNotGenerateFriendlyCapture()
        {
            ...
            // Assert
            Assert.That(_outputBuffer.Count, Is.EqualTo(1));
            Assert.That(_outputBuffer[0].EndPosition, Is.EqualTo(BoardSetup.AlgebraicToVector("e5")));
        }
        ...
        public void GetLegalMoves_WhitePawnOnSeventhRank_ReturnsAllFourPromotionVariants()
        {
            ...
            // Act
            ChessEngine.GetLegalMoves(board, BoardSetup.AlgebraicToVector("e7"), _outputBuffer);
            ...
            {
                Assert.That(move.EndPosition, Is.EqualTo(BoardSetup.AlgebraicToVector("e8")));
        ...
        public void GetLegalMoves_WhitePawnOnSeventhRankWithCapture_ReturnsEightPromotionVariants()
        {
            ...
            foreach (var move in _outputBuffer)
            {
                ...
                else if (move.EndPosition == BoardSetup.AlgebraicToVector("e8"))
                {
        ...
        public void GetLegalMoves_PawnEnPassantAvailable_ReturnsEnPassantMove()
        {
            ...
            // Act
            ChessEngine.GetLegalMoves(board, BoardSetup.AlgebraicToVector("e5"), _outputBuffer);
            ...
            Assert.That(enPassantMove.Value.EndPosition, Is.EqualTo(BoardSetup.AlgebraicToVector("f6")));
            Assert.That(enPassantMove.Value.EnPassantCapturePosition, Is.EqualTo(BoardSetup.AlgebraicToVector("f5")));
        }
        ...
        public void GetLegalMoves_PawnPinnedDiagonallyCanStillCaptureAlongPinLine()
        {
            ...
            // Act
            ChessEngine.GetLegalMoves(board, BoardSetup.AlgebraicToVector("d2"), _outputBuffer);

            // Assert
            Assert.That(_outputBuffer.Count, Is.EqualTo(1));
            Assert.That(_outputBuffer[0].EndPosition, Is.EqualTo(BoardSetup.AlgebraicToVector("c3")), "Pawn can capture the pinning bishop.");
        ...
        public void GetLegalMoves_BlackPawnOnStartingRank_ReturnsCorrectDownwardMoves()
        {
            ...
            Assert.That(_outputBuffer.Count, Is.EqualTo(2));
            HashSet<Vector2Int> destinations = BoardSetup.GetDestinations(_outputBuffer);
            Assert.That(destinations, Contains.Item(BoardSetup.AlgebraicToVector("e6")));
            Assert.That(destinations, Contains.Item(BoardSetup.AlgebraicToVector("e5")));
        }
        ...
        public void WithPiece_PawnAtMidBoardWithHasMovedFalse_DoesNotGenerateDoublePush()
        {
            ...
            Vector2Int pawnPos = BoardSetup.AlgebraicToVector("e4");
            Vector2Int illegalDoublePush = BoardSetup.AlgebraicToVector("e6");
            ...
            Vector2Int correctSinglePush = BoardSetup.AlgebraicToVector("e5");
        ...
        public void GetLegalMoves_EnPassantDiscoveredCheck_PawnCannotCaptureEnPassant()
        {
            ...
            HashSet<Vector2Int> destinations = BoardSetup.GetDestinations(_outputBuffer);
            Assert.That(destinations.Contains(BoardSetup.AlgebraicToVector("e6")), Is.True,
