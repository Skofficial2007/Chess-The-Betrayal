...
namespace ChessTheBetrayal.Tests.EditMode.Support
{
    ...
    public class BoardSetupTests
    {
        ...
        public void AlgebraicToVector_ValidCoordinates_ReturnsCorrectVector2Int(string algebraic, int expectedX, int expectedY)
        {
            ...
            // Act
            Vector2Int actual = BoardSetup.AlgebraicToVector(algebraic);
        ...
        {
            // Arrange & Act & Assert
            Assert.Throws<ArgumentException>(() => BoardSetup.AlgebraicToVector(algebraic));
        }
        ...
        public void CreateStandard_WhenCalled_Returns32PiecesWithCorrectPositions()
        {
            ...
            Assert.That(board.GetPiece(BoardSetup.AlgebraicToVector("e1")).Type, Is.EqualTo(ChessPieceType.King));
            Assert.That(board.GetPiece(BoardSetup.AlgebraicToVector("e1")).Team, Is.EqualTo(Team.White));

            Assert.That(board.GetPiece(BoardSetup.AlgebraicToVector("e8")).Type, Is.EqualTo(ChessPieceType.King));
            Assert.That(board.GetPiece(BoardSetup.AlgebraicToVector("e8")).Team, Is.EqualTo(Team.Black));
        ...
        public void WithPiece_FluentChaining_PlacesMultiplePiecesCorrectly()
        {
            ...
            // Assert
            PieceData e4Piece = board.GetPiece(BoardSetup.AlgebraicToVector("e4"));
            ...
            PieceData d5Piece = board.GetPiece(BoardSetup.AlgebraicToVector("d5"));
            ...
            Assert.That(board.GetPiece(BoardSetup.AlgebraicToVector("a1")).Type, Is.EqualTo(ChessPieceType.Rook));
        }
    }
}